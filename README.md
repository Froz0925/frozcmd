...
Автоматизирует импорт видео `.mts` с фотоаппарата Panasonic (структура папок стандарта AVCHD) и их конвертацию в контейнер `.mkv` (без перекодирования) с именем по дате.
